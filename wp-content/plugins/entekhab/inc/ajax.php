...
add_action( 'wp_ajax_nopriv_dsl_login', 'entekhab_sms_login' );


function entekhab_sms_login(){
    global $wpdb;
    $result = [
...
// add_action( 'wp_ajax_nopriv_dsl_verify', 'entekhab_sms_verify' );
// function entekhab_sms_verify(){
