<?php
     ...
     * Author:Tilda !__!
     * Description: this plugin has a 10 sentence and evry time it show you just one of them! 
     * Plugin Uri: test.local

     */

    defined('ABSPATH') || exit;
    define('RANDOM_CENTENCE' , plugin_dir_path(__FILE__).'view/'); 

     function func_for_print_sentence_style(){

        include(RANDOM_CENTENCE . 'style.php');
      
     }
     add_action('wp_head' , 'func_for_print_sentence_style');

     
     function func_for_print_sentence_body(){
        $sentences = [
            [
       ...
       include(RANDOM_CENTENCE . 'body.php');

     }
     add_action('wp_footer' , 'func_for_print_sentence_body');
?>